...
documant_path = "../Corpus/LISA/split/docs/numeric"
query_path = "../Corpus/LISA/split/queries/suffix_01"
...
while isBreak != "exit":
        ...
        for my_lambda in np.arange(0.4, 0.6, interval):
                docs_point = {}
                AP = 0
                mAP = 0
